...
<div class="row m-0">
        ...
        <div class="register-form-container">
            ...
            <form action="<?php echo e(route('register')); ?>" method="POST">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="email" name="email" class="form-control" required placeholder="ihda@gmail.com">
                </div>
                <div class="form-group mb-3">
            ...
            <p class="text-center">Sudah Punya Akun? <a href="<?php echo e(route('login')); ?>">Masuk</a></p>
        </div>
    </div>
    ...
    <div class="col-md-6 right-section">
        <div class="right-section-content">
            <img src="images/hero-bg 1.png" alt="Small Image"> <!-- Replace 'hero-bg-2.png' with the path to your image -->
        </div>
    </div>
</div>
...
<?php /**PATH C:\xampp\htdocs\hackhthin2\resources\views/auth/register.blade.php ENDPATH**/ ?>