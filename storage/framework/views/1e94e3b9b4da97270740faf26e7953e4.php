...
<div class="container mt-5">
    ...
    <form action="<?php echo e(route('profile.update')); ?>" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <img id="profile-picture-preview" src="<?php echo e($user->profile_picture ? asset('storage/' . $user->profile_picture) : asset('images/default-avatar.png')); ?>" alt="Profile Picture" style="width: 150px; height: 150px; border-radius: 50%;">
